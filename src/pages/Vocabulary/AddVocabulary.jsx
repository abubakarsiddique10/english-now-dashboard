...
const AddVocabulary = () => {
    ...
    const { word, meaning, image, category, synonym, antonym, sentence } = value;
    ...
    const handleSubmit = (e) => {
        ...
        synonym.forEach(item => formData.append('synonym[]', item))
        antonym.forEach(item => formData.append('antonym[]', item))
